          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button size="lg" className="!bg-yellow-400 hover:!bg-yellow-300 active:!bg-yellow-500 text-black font-semibold px-8 py-4 rounded-lg text-lg transition-all duration-200 hover:scale-105 active:scale-95 hover:shadow-lg active:shadow-inner"
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why taeraetickets?</h2>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="!bg-black text-white hover:!bg-gray-700 active:!bg-gray-900 shadow-lg font-semibold px-8 py-4 transition-all duration-200 hover:scale-105 active:scale-95 hover:shadow-xl active:shadow-inner"
              onClick={() => window.location.href = '/auth/signup'}>
                Start Selling
              </Button>
              <Button size="lg" className="!bg-black text-white hover:!bg-gray-700 active:!bg-gray-900 shadow-lg font-semibold px-8 py-4 transition-all duration-200 hover:scale-105 active:scale-95 hover:shadow-xl active:shadow-inner"
