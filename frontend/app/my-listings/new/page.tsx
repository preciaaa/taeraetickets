      ...
      <div className="mb-10 text-center">
        ...
        <Card className="rounded-2xl shadow-xl border border-gray-100 bg-white/90 mb-8">
          <CardHeader className="pb-6">
            ...
            <CardDescription className="text-gray-500 text-base leading-relaxed">Search for an existing event or create a new one</CardDescription>
          </CardHeader>
