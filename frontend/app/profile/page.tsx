      ...
      <div className="max-w-xl mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-md space-y-6">
        ...
        <div className="flex flex-col items-center">
          <div className="relative">
            <img src={selectedPic} alt="Profile" className="w-40 h-40 object-contain" />
            <button
              type="button"
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                {PROFILE_IMAGES.map((img) => (
                  ...
                  >
                    <img src={img} alt="Option" className="w-20 h-20 object-contain rounded-md mx-auto" />
                  </button>
                ))}
              </div>
              <div className="flex justify-end gap-2">
                ...
                <Button
                  onClick={async () => {
                    ...
                    if (user && tempPic) {
                      await supabase.auth.updateUser({ data: { profile_pic: tempPic } });
