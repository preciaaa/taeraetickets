                            ...
                            <div className="grid grid-cols-3 gap-4 mb-4">
                                {PROFILE_IMAGES.map((img) => (
                                    <button
                                        ...
                                        className={`p-1 border-2 rounded-xl w-30 h-30 bg-white shadow-sm transition-all duration-150 hover:scale-105 ${tempPic === img ? "border-blue-500 ring-4 ring-blue-300" : "border-transparent"
                                            }`}
                                    >
                                        <img
                                            src={img}
